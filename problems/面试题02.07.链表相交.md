...
我们求出两个链表的长度，并求出两个链表长度的差值，然后让curA移动到，和curB 末尾**对齐**的位置，如图：
...
## 思路解释
详细的解释为什么对齐之后，若相交于一点，在距离相同,速度又相同的情况下，必定会同一时间走到相同的节点上。
...
![面试题02.07.链表相交_3](https://pic.leetcode-cn.com/9361ba6ca0b2203a0304156cb3d5e10337836d52f4a41464b66854ea0562418f-ListNode.png)
